...
# the corresponding new word. All the fields in mainfile will be replaced. This script is useful
# especially when the replace list is very long.
#
...
BEGIN{
    if(ARGC<2){
        ...
        print "format in listfile: original new"               > "/dev/stderr";
        exit;
    }
    listfile = ARGV[1];
}
